...
def main():
    ...
    output_dir = resolve_repo_path("outputs", "pima_full")
    summary_exp_names = [
    ...
    save_teacher_reports(teacher, prefix="teacher_pima_full", output_dir=output_dir)
    ...
    run_student_cv(
        ...
        epochs=80,
        batch_size=32,
        exp_name="pima_student_classic_full",
    )
    ...
    run_student_cv(
        ...
        epochs=80,
        batch_size=32,
        exp_name="pima_student_classic_kd_full",
    )
    ...
    run_student_cv(
        ...
        epochs=80,
        batch_size=8,
        exp_name="pima_student_hybrid_nokd_full",
    )
    ...
    run_student_cv(
        ...
        epochs=80,
        batch_size=8,
        exp_name="pima_student_hybrid_kd_full",
    )
